...
class Home extends CI_Controller {
	...
	public function index()
	{
		...
		$businessData = getApiData(BUSINESS_DETAILS, BAUTH_KEY, ['options' =>['business_id'=>BUSINESSID]]);
		$data['testimonialsData'] = getApiData(INQUIRY_API_URL, BAUTH_KEY, ['business_id'=>BUSINESSID,'type'=>'business_testimonial']);
