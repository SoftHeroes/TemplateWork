...
$(function() {
  ...
  wind.on("scroll", function() {
    ...
    var bodyScroll = wind.scrollTop(), navbar = $(".navbar"),
  ...
  $(".navbar-nav a")
      .on('click', function() { $(".navbar-collapse")
                                    .removeClass("show"); });
...
-----------------------------------------------------------------*/
  ...
  $('.numbers .count').countUp({delay: 10, time: 1500});
  ...
  // parallaxie
  $('.parallaxie').parallaxie({speed: 0.6, size: "cover"});
